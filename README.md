...
**[forgerock-am-journey-scripts](https://github.com/vamsh1x/forgerock-am-journey-scripts)** - curated JavaScript scripts for ForgeRock AM / PingAM authentication tree journeys (Scripted Decision nodes): login security, adaptive risk, registration validation, OTP resend throttling, and utilities.
